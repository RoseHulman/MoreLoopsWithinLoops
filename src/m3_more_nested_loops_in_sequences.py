...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 99987
    answer = largest_number(([99987], [123], [75749]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -100
    answer = largest_negative_number([(-13, -12, -4),
                             (13, -100, 1, -79, -1),
                             [-1, 62, 63, 94]])
    print('Expected and actual are:', expected, answer)
    ...
    # Test 2:
    expected = -1789
    answer = largest_negative_number(([], [-1], [-1789]))
    print('Expected and actual are:', expected, answer)
    ...
    # Test 4:
    expected = -987
    answer = largest_negative_number(([-987], [-823], [75749]))
    print('Expected and actual are:', expected, answer)
...
def first_is_elsewhere_too(seq_seq):
    ...
    for k in range(1, len(seq_seq), 1):
        ...
        for j in range(len(subseq)):
            numbers = subseq[j]
            for m in range(len(compare)):
                if compare[m] == numbers:
                    return True
    return False
